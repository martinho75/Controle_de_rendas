...
<div class="container py-4 ">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Fatura Listada 
                ...
                <form >  
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control"  value={{ $fatura->inclino->nome ?? $fatura->id_inclino }} disabled>
                    </div>

                     <div class="mb-3">
                        <label class="form-label">Imovel</label>
                        <input type="text" class="form-control"  value={{ $fatura->imovel->nome  ?? $fatura->id_imovel}} disabled>
                    </div>
